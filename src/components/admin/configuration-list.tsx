                    ...
                    <Table>
                        ...
                        <TableBody>
                            {filteredBoards.length === 0 ? (
                                ...
                                (() => {
                                    const tableRows = filteredBoards.flatMap(board =>
                                        board.classes.length === 0 ? [{
                                            board,
                                            class: null,
                                            isEmptyBoard: true
                                        } as TableRowData] : board.classes.map(cls => ({
                                            board,
                                            class: cls,
                                            isEmptyBoard: false
                                        } as TableRowData))
                                    ...
                                    return tableRows.map((item, index) => (
                                        <TableRow key={item.isEmptyBoard ? item.board.id : item.class!.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 border-b border-gray-50 dark:border-gray-800 transition-colors">
                                            {item.isEmptyBoard ? (
                                                <>
                                                    <TableCell>
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="font-bold text-gray-900 dark:text-white">{item.board.name}</span>
                                                        </div>
                                                    </TableCell>
                                                    ...
                                                    <TableCell className="text-right">
                                                        <div className="flex items-center justify-end gap-1">
                                                            <Dialog>
                                                                ...
                                                                <DialogContent className="sm:max-w-[400px]">
                                                                    ...
                                                                    <form action={async (formData) => {
                                                                        ...
                                                                        <input type="hidden" name="id" value={item.board.id} />
                                                                        <div className="grid gap-2">
                                                                            <Label className="font-bold">Board Name</Label>
                                                                            <Input name="name" defaultValue={item.board.name} required />
                                                                        </div>
                                                            ...
                                                            <DeleteConfirm onDelete={async () => {
                                                                return await deleteBoard(item.board.id);
                                                            }} />
                                                            <Dialog>
                                                                <DialogTrigger asChild>
                                                                ...
                                                                <DialogContent className="sm:max-w-[550px]">
                                                                    <DialogHeader>
                                                                        <DialogTitle className="font-heading text-lg">Add Class to {item.board.name}</DialogTitle>
                                                                        <DialogDescription>Create a class and optionally assign subjects.</DialogDescription>
                                                                    </DialogHeader>
                                                                    <form action={async (formData) => {
                                                                        formData.set('boardId', item.board.id);
                                                                        await createClass(formData);
                                                ...
                                                <>
                                                    <TableCell>
                                                        {index === 0 || tableRows[index - 1].board.id !== item.board.id ? (
                                                            <div className="flex items-center gap-2">
                                                                <div className="p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded">
                                                                    <School className="h-4 w-4 text-blue-600" />
                                                                </div>
                                                    ...
                                                    <TableCell>
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="font-bold text-gray-900 dark:text-white">{item.class!.name}</span>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
                                                        <Badge variant="outline" className="text-xs font-medium">
                                                            {item.class!.section || 'No Section'}
                                                        </Badge>
                                                    </TableCell>
                                                    <TableCell>
                                                        <div className="flex items-center gap-2">
                                                            <Badge variant="secondary" className="bg-orange-50 text-orange-700 border-orange-100 font-bold" title={item.class!.subjects.map(s => s.name).join(', ')}>
                                                                {item.class!.subjects.length} Subjects Linked
                                                            </Badge>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
                                                        <Badge className="bg-emerald-50 text-emerald-600 hover:bg-emerald-50 border-0 font-bold text-xs">
                                                            {item.class!._count.students} Students
                                                        </Badge>
                                                    </TableCell>
                                                    <TableCell className="text-right">
                                                        <div className="flex items-center justify-end gap-1">
                                                            <Dialog>
                                                                ...
                                                                <DialogContent>
                                                                    ...
                                                                    <form action={async (formData) => {
                                                                        ...
                                                                        <input type="hidden" name="id" value={item.class!.id} />
                                                                        <input type="hidden" name="boardId" value={item.board.id} />
                                                                        <div className="grid grid-cols-2 gap-4">
                                                                            <div className="grid gap-2">
                                                                                <Label className="font-bold">Class Name</Label>
                                                                                <Input name="name" defaultValue={item.class!.name} required />
                                                                            </div>
                                                                            <div className="grid gap-2">
                                                                                <Label className="font-bold">Section</Label>
                                                                                <Input name="section" defaultValue={item.class!.section || ''} />
                                                                            </div>
                                                                        </div>
                                                                                    ...
                                                                                    {['primary', 'secondary', 'elective'].map(category => {
                                                                                        ...
                                                                                        return (
                                                                                            <div key={category} className="space-y-2">
                                                                                                ...
                                                                                                <div className="flex flex-wrap gap-2">
                                                                                                    {categorySubjects.map(sm => {
                                                                                                        const isChecked = item.class!.subjects.some(s => s.subjectMasterId === sm.id);
                                                                                                        return (
                                                                                                            <label key={sm.id} className={`flex items-center gap-2 px-2.5 py-1 rounded-lg cursor-pointer border ${colors.border} ${colors.bg} hover:opacity-80 transition-opacity`}>
                                                                                                                <input
                                                                                                                    type="checkbox"
                                                            ...
                                                            <DeleteConfirm onDelete={async () => {
                                                                return await deleteClass(item.class!.id);
                                                            }} />
                                                            <Dialog>
                                                                <DialogTrigger asChild>
                                                                    <Button size="sm" variant="outline" className="h-8 text-xs font-bold">
                                                                ...
                                                                <DialogContent className="sm:max-w-[500px]">
                                                                    <DialogHeader>
                                                                        <DialogTitle className="font-heading text-lg">Add Subjects to {item.class!.name}</DialogTitle>
                                                                        <DialogDescription>Select subjects to add to this class.</DialogDescription>
                                                                    </DialogHeader>
                                                                    <form action={async (formData) => {
                                                                        formData.set('classId', item.class!.id);
                                                                                ...
                                                                                {['primary', 'secondary', 'elective'].map(category => {
                                                                                    ...
                                                                                    return (
                                                                                        <div key={category} className="space-y-2">
                                                                                            ...
                                                                                            <div className="flex flex-wrap gap-2">
                                                                                                {categorySubjects.map(sm => {
                                                                                                    const isAlreadyAdded = item.class!.subjects.some(s => s.subjectMasterId === sm.id);

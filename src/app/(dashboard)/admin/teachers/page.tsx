...
import { Plus, Edit2, Phone, Mail, GraduationCap as GradIcon, Filter } from 'lucide-react';
                                ...
                                <div className="space-y-4 pt-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="grid gap-1.5">
                                            ...
                                            <p className="text-[10px] text-muted-foreground italic">Most recent degree attained.</p>
                                        </div>
                                        <div className="grid gap-1.5">
                                    ...
                                    <div className="grid gap-1.5">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            {subjectMasters.map(sm => (
                                                <label key={sm.id} className="flex items-center gap-2 border px-3 py-1.5 rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                                                    <input type="checkbox" name="specialization" value={sm.name} className="h-3.5 w-3.5 accent-primary" />
                                        ...
                                        <p className="text-[10px] text-muted-foreground italic">Select global subjects.</p>
                                    </div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {classGroups.map(group => (
                                                <label key={group} className="flex items-center gap-2 border px-3 py-1.5 rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                                                    <input type="checkbox" name="classes" value={group} className="h-3.5 w-3.5 accent-primary" />
                                    ...
                                    <div className="grid gap-1.5">
                                        ...
                                        <p className="text-[10px] text-muted-foreground italic">Previous employers.</p>
                                    </div>
                                </div>
